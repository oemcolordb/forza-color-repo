  ...
  parsePacket(buffer) {
    ...
    return {
      ...
      suspensionTravelNormalized: [
        buffer.readFloatLE(68), buffer.readFloatLE(72),
        buffer.readFloatLE(76), buffer.readFloatLE(80)
      ],
      
      // Suspension (meters)
      suspensionTravelMeters: [
        buffer.readFloatLE(84), buffer.readFloatLE(88),
        buffer.readFloatLE(92), buffer.readFloatLE(96)
      ],
      
      // Wheel rotation speed (rad/s)
      wheelRotationSpeed: [
        buffer.readFloatLE(100), buffer.readFloatLE(104),
        buffer.readFloatLE(108), buffer.readFloatLE(112)
      ],
      
      // Wheel on rumble strip (0/1)
      wheelOnRumbleStrip: [
        buffer.readInt32LE(116), buffer.readInt32LE(120),
        buffer.readInt32LE(124), buffer.readInt32LE(128)
      ],
      
      // Wheel in puddle (0-1)
      wheelInPuddleDepth: [
        buffer.readFloatLE(132), buffer.readFloatLE(136),
        buffer.readFloatLE(140), buffer.readFloatLE(144)
      ],
      
      // Surface rumble
      surfaceRumble: [
        buffer.readFloatLE(148), buffer.readFloatLE(152),
        buffer.readFloatLE(156), buffer.readFloatLE(160)
      ],
      
      // Tire slip ratio
      tireSlipRatio: [
        buffer.readFloatLE(164), buffer.readFloatLE(168),
        buffer.readFloatLE(172), buffer.readFloatLE(176)
      ],
      
      // Tire slip angle
      tireSlipAngle: [
        buffer.readFloatLE(180), buffer.readFloatLE(184),
        buffer.readFloatLE(188), buffer.readFloatLE(192)
      ],
      
      // Tire combined slip
      tireCombinedSlip: [
        buffer.readFloatLE(196), buffer.readFloatLE(200),
        buffer.readFloatLE(204), buffer.readFloatLE(208)
      ],
      
      // Tire temperature
      tireTemp: [
        buffer.readFloatLE(212), buffer.readFloatLE(216),
        buffer.readFloatLE(220), buffer.readFloatLE(224)
      ],
      
      // Tire wear
      tireWear: [
        buffer.readFloatLE(228), buffer.readFloatLE(232),
        buffer.readFloatLE(236), buffer.readFloatLE(240)
      ],
