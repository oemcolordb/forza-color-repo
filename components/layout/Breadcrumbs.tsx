...
function BreadcrumbsInner({ isDarkMode }: BreadcrumbsProps) {
...
// Wrap in Suspense because usePathname() requires LayoutRouterContext
// which is only available client-side during static prerendering
