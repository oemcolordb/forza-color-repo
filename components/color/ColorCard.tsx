...
interface ColorCardProps {
  ...
  isFavorite?: boolean
  onToggleFavorite?: (color: CarColor) => void
  isTrending?: boolean
...
const ColorCard: React.FC<ColorCardProps> = React.memo(
  ({ color, onSelect, onShowInfo, isFavorite = false, onToggleFavorite, isTrending = false, isCommunityChoice = false, isDarkMode = true }) => {
