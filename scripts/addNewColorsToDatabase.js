...
const newColors = [
  ...
  },
  {
    ...
    colorType: 'Two-Tone Matte',
    color1: { h: 0.92, s: 0.9, b: 0.88 },
    color2: { h: 0.33, s: 0.95, b: 0.2 },
  },
  {
    make: 'Bugatti',
    model: 'Chiron',
