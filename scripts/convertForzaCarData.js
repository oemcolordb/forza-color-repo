...
const CARS = [
  {
    ...
    distribution: 52,
    drivetrain: 'RWD',
    class: 'Modern Sports Cars',
  },
  {
    id: 'abarth-695-biposto-2016',
    make: 'Abarth',
    model: '695 Biposto',
    year: 2016,
    weightLbs: 2198,
  ...
  },
  {
    ...
    distribution: 42,
    drivetrain: 'AWD',
    class: 'Modern Supercars',
  },
  {
    id: 'acura-rsx-type-s-2002',
    make: 'Acura',
    model: 'RSX Type-S',
    year: 2002,
    weightLbs: 2776,
  ...
  {
    id: 'alfa-romeo-33-stradale-1968',
    make: 'Alfa Romeo',
    model: '33 Stradale',
    year: 1968,
    weightLbs: 1543,
    distribution: 43,
    drivetrain: 'RWD',
    class: 'Classic Racers',
  },
  {
    id: 'alfa-romeo-giulia-sprint-gta-stradale-1965',
    make: 'Alfa Romeo',
  ...
  {
    id: 'alumicraft-6165-trick-truck-2022',
    make: 'Alumicraft',
    ...
    distribution: 50,
    drivetrain: 'RWD',
    class: 'Unlimited Offroad',
  },
  {
    id: 'alumicraft-122-class-1-buggy-2021',
    make: 'Alumicraft',
    ...
    distribution: 45,
    drivetrain: 'RWD',
    class: 'Unlimited Buggies',
  },
  {
    id: 'alumicraft-class-10-race-car-2015',
    make: 'Alumicraft',
  ...
  {
    id: 'amg-transport-dynamics-m12s-warthog-cst-2554',
  ...
  {
    id: 'apollo-intensa-emozione-2018',
    make: 'Apollo',
    ...
    distribution: 45,
    drivetrain: 'RWD',
    class: 'Extreme Track Toys',
  },
  {
    id: 'apollo-intensa-emozione-welcome-pack-2018',
    make: 'Apollo',
  ...
  {
    id: 'aston-martin-valkyrie-amr-pro-2022',
    make: 'Aston Martin',
  ...
  {
    id: 'aston-martin-valhalla-concept-car-2019',
    make: 'Aston Martin',
  ...
  {
    id: 'aston-martin-vanquish-zagato-coupe-2017',
    make: 'Aston Martin',
  ...
  {
    id: 'aston-martin-vulcan-amr-pro-2017',
    make: 'Aston Martin',
  ...
  {
    id: 'aston-martin-vantage-gt12-2016',
    make: 'Aston Martin',
    model: 'Vantage GT12',
    year: 2016,
    weightLbs: 3450,
  ...
  {
    id: 'aston-martin-v12-vantage-s-2013',
    make: 'Aston Martin',
    model: 'V12 Vantage S',
    year: 2013,
    weightLbs: 3671,
...
function getCountry(make) {
  const countryMap = {
    ...
    AMC: 'United States',
    'AMG Transport Dynamics': 'United States',
    Apollo: 'Germany',
    ...
    Exomotive: 'United States',
    'Extreme E': 'International',
    'Fast and Furious': 'United States',
    Ferrari: 'Italy',
    FIAT: 'Italy',
    Ford: 'United States',
    'Formula Drift': 'United States',
    'Forsberg Racing': 'United States',
    'Funco Motorsports': 'United States',
    GMC: 'United States',
    Hennessey: 'United States',
    Holden: 'Australia',
    Honda: 'Japan',
    Hoonigan: 'United States',
...
function getRarity(forzaClass) {
  const rarityMap = {
    ...
    'Classic Rally': 'Epic',
    'Hot Hatch': 'Common',
    'Modern Sports Cars': 'Rare',
    'Modern Supercars': 'Epic',
    'Retro Hot Hatch': 'Rare',
    'Super Saloons': 'Epic',
    'GT Cars': 'Rare',
    'Sports Utility Heroes': 'Common',
    'Super GT': 'Epic',
    'Extreme Track Toys': 'Legendary',
    'Track Toys': 'Epic',
    'Rare Classics': 'Legendary',
    'Classic Racers': 'Legendary',
    'Unlimited Offroad': 'Epic',
    'Unlimited Buggies': 'Epic',
    'Classic Muscle': 'Epic',
    'Retro Sports Cars': 'Rare',
    Hypercars: 'Legendary',
    'Rally Monsters': 'Epic',
    'Retro Saloons': 'Rare',
    'Pickups & 4x4s': 'Common',
    ...
    'Retro Muscle': 'Rare',
    'Drift Cars': 'Rare',
    'Rods and Customs': 'Rare',
    "UTV's": 'Common',
    'Vintage Racers': 'Legendary',
  }
...
function generateTags(car) {
  ...
  if (
    ['Honda', 'Toyota', 'Nissan', 'Mazda', 'Subaru', 'Mitsubishi', 'Acura', 'Infiniti'].includes(
      car.make
    )
  ) {
    tags.push('JDM')
