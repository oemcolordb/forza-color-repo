        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          >
            <div className={`p-6 border-b flex justify-between items-center ${isDarkMode ? 'border-white/5' : 'border-gray-100'}`}>
              <h2 className="text-xl font-black italic tracking-tighter uppercase">Share Your <span className="text-blue-500">Build</span></h2>
            ...
            <form onSubmit={handleUpload} className="p-6 space-y-4">
              ...
              <div 
                className={`aspect-video rounded-2xl border-2 border-dashed flex flex-col items-center justify-center relative overflow-hidden transition-colors ${
                  isDarkMode ? 'border-white/10 bg-white/5 hover:bg-white/10' : 'border-gray-200 bg-gray-50 hover:bg-gray-100'
                }`}
              >
                {preview ? (
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-[10px] font-black uppercase tracking-widest opacity-50">Car Model</label>
                  <input 
                    value={carName}
                    ...
                    className={`w-full px-4 py-3 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 ${
                      isDarkMode ? 'bg-white/5 border border-white/10 text-white' : 'bg-gray-50 border border-gray-100'
                    }`}
                  />
                </div>
                <div className="space-y-1">
                  <label className="text-[10px] font-black uppercase tracking-widest opacity-50">Share Code</label>
                  <input 
                    value={tuneCode}
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-black uppercase tracking-widest opacity-50">Caption</label>
                <textarea 
                  value={caption}
