...
interface ColorTypeBrowserProps {
  colors: CarColor[]
  isDarkMode: boolean
  onColorTypeSelect: (type: string) => void
}

const ColorTypeBrowser: React.FC<ColorTypeBrowserProps> = ({ colors, isDarkMode, onColorTypeSelect }) => {
