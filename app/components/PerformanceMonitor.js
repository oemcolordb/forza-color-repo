...
const PerformanceMonitor = ({ isDarkMode, deviceInfo }) => {
  ...
  return (
    <div className={`fixed bottom-4 right-4 p-2 rounded-lg text-xs font-mono z-50 ${
      isDarkMode ? 'bg-slate-800/90 text-slate-300 border border-slate-600' : 'bg-white/90 text-gray-700 border border-gray-300'
    }`}>
