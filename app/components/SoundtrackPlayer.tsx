...
const SoundtrackPlayer: React.FC<SoundtrackPlayerProps> = ({ isDarkMode }) => {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full h-full -z-[100] overflow-hidden bg-black pointer-events-none">
      ...
      >
        ...
        {/* Extended controls pop-out on hover */}
