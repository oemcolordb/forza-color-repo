...
export default function ForzaColorSheetSEO({ 
  ...
  useEffect(() => {
    ...
    const forzaMetaTags = [
      ...
      { name: 'search:keywords', content: 'forza color sheet,forza colors database,automotive paint colors,racing game colors' }
    ]
    ...
    const ogTags = [
      ...
      { property: 'og:image', content: 'https://forza-color-repo.vercel.app/forza-color-sheet-preview.jpg' },
    ...
    const twitterTags = [
      ...
      { name: 'twitter:image', content: 'https://forza-color-repo.vercel.app/forza-color-sheet-preview.jpg' }
    ]
    ...
    const forzaStructuredData = {
      ...
      "@graph": [
        ...
        },
        {
          ...
          "url": "https://forza-color-repo.vercel.app",
          "description": "Interactive Forza color sheet with advanced search, filtering, and color matching capabilities",
          "featureList": [
  ...
  useEffect(() => {
    ...
    let breadcrumbScript = document.getElementById('breadcrumb-structured-data') as HTMLScriptElement
    if (!breadcrumbScript) {
