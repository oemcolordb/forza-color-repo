...
const TokyoBackground: React.FC<TokyoBackgroundProps> = ({ isDarkMode, getSecureAssetUrl }) => {
  ...
  const selectedMedia = useMemo(() => {
    const mediaFiles = [
      ...
      { file: 'japan/photo-1498036882173-b41c28a8ba34.avif', type: 'image' as const },
      { file: 'japan/photo-1503899036084-c55cdd92da26.avif', type: 'image' as const },
      { file: 'japan/photo-1513407030348-c983a97b98d8.avif', type: 'image' as const },
      { file: 'japan/photo-1536098561742-ca998e48cbcc.avif', type: 'image' as const },
      { file: 'japan/photo-1540959733332-eab4deabeeaf.avif', type: 'image' as const },
      { file: 'japan/photo-1545569341-9eb8b30979d9.avif', type: 'image' as const },
      { file: 'japan/photo-1549693578-d683be217e58.avif', type: 'image' as const },
      { file: 'japan/photo-1551641506-ee5bf4cb45f1.avif', type: 'image' as const },
      { file: 'japan/photo-1554797589-7241bb691973.avif', type: 'image' as const },
      { file: 'japan/photo-1557409518-691ebcd96038.avif', type: 'image' as const },
      { file: 'japan/photo-1604928141064-207cea6f571f.avif', type: 'image' as const },
      { file: 'japan/premium_photo-1661902398022-762e88ff3f82.avif', type: 'image' as const },
      { file: 'japan/premium_photo-1661914240950-b0124f20a5c1.avif', type: 'image' as const },
      { file: 'japan/premium_photo-1661964177687-57387c2cbd14.avif', type: 'image' as const },
      { file: 'japan/premium_photo-1666700698920-d2d2bba589f8.avif', type: 'image' as const },
      {
