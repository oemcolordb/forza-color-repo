      ...
      <div
        ...
        onClick={e => {
          ...
          if (
            ...
            (e.target as HTMLElement).closest('.color-info-area')
          ) {
            onSelect(color)
          }
        }}
        ...
        >
          ...
          {(color.colorType?.toLowerCase().includes('gloss') ||
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(135deg, transparent 0%, rgba(255,255,255,0.6) 45%, rgba(255,255,255,0.8) 50%, rgba(255,255,255,0.6) 55%, transparent 100%)',
              }}
            />
          )}
