...
export default function EnhancedAuthModal({ isOpen, onClose, isDarkMode }: EnhancedAuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div
        className={`w-full max-w-md rounded-xl shadow-2xl ${isDarkMode ? 'bg-slate-800' : 'bg-white'}`}
      >
        {/* Header */}
        ...
        <div className="p-6">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span
                className={`px-2 ${isDarkMode ? 'bg-slate-800 text-gray-400' : 'bg-white text-gray-500'}`}
              >
