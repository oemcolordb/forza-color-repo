...
export const CarStatsRadarChart = ({ stats, size = 200, isDarkMode = true }) => {
    ...
    useEffect(() => {
        ...
        const statValues = [stats.speed, stats.handling, stats.acceleration, stats.launch, stats.braking, stats.offroad];
        const maxValue = 10;
    ...
    const handleMouseMove = (event) => {
        ...
        for (let i = 0; i < 6; i++) {
            const angle = (i * Math.PI) / 3 - Math.PI / 2;
            const value = Math.min([stats.speed, stats.handling, stats.acceleration, stats.launch, stats.braking, stats.offroad][i], 10) / 10;
    ...
    return (
        <div className="relative">
            ...
            />
            {hoveredStat !== null && (
                <div className={`absolute top-0 left-full ml-2 p-2 rounded shadow-lg z-10 ${
                    ...
                    <div className="text-lg font-bold text-blue-500">
                        {[stats.speed, stats.handling, stats.acceleration, stats.launch, stats.braking, stats.offroad][hoveredStat].toFixed(1)}/10
                    </div>
                </div>
            )}
        </div>
