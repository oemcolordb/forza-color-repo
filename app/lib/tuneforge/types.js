...
export const CAR_TYPE_DEFAULTS = {
  ...
  Supercar: {
    'tire-pressure-front': 1.8,
    'tire-pressure-rear': 1.7,
    'camber-front': 2.0,
    'camber-rear': 1.5,
    'toe-front': -0.1,
    'toe-rear': 0.1,
  ...
  Truck: {
    'tire-pressure-front': 2.2,
    'tire-pressure-rear': 2.1,
    'camber-front': 0.8,
    'camber-rear': 0.5,
    'toe-front': 0.1,
    'toe-rear': 0.2,
...
export const GEAR_RATIO_BLUEPRINTS = {
  'Road Race': [3.2, 2.1, 1.6, 1.25, 1.05, 0.9, 0.8, 0.72, 0.65, 0.6],
  'Drag Race': [2.8, 1.9, 1.45, 1.15, 0.95, 0.8, 0.7, 0.62, 0.55, 0.5],
  Drift: [3.5, 2.3, 1.75, 1.35, 1.1, 0.95, 0.85, 0.78, 0.7, 0.65],
  Offroad: [3.8, 2.5, 1.8, 1.3, 1.0, 0.8, 0.65, 0.55, 0.48, 0.42],
  Rally: [3.6, 2.4, 1.7, 1.28, 1.0, 0.82, 0.68, 0.58, 0.5, 0.45],
}

export function validateCarData(car) {
  return car && car.year && car.manufacturer && car.model && car.stats && car.pi && car.drivetrain
}
