...
interface TuningOptions {
  weight?: number
  gearCount?: number
  handlingBalance?: number | null
  bumpStiffness?: number | null
  springFrequency?: number | null
...
export class TuningCalculator {
  ...
  constructor(carData: CarData, options: TuningOptions = {}) {
    this.car      = carData
