              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="leading-relaxed">
                    Use the search bar to find colors by name, manufacturer, or model. Click on any
                    color card to view detailed information including HSB values and color type.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-medium mb-2">🔍 Filtering Results</h3>
                  <p className="leading-relaxed">
                    Use the filter controls to narrow down results by manufacturer, color type, or
                    other criteria. Filters can be combined for more precise searches.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-medium mb-2">🎮 Telemetry Dashboard</h3>
                  <p className="leading-relaxed">
                    Connect your Forza Horizon 5 game to view real-time telemetry data on the
                    /telemetry page. Perfect for analyzing car performance.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-medium mb-2">
                    📊 How many colors are in the database?
                  </h3>
                  <p className="leading-relaxed">
                    Our database contains over 10,000 official automotive paint colors extracted
                    from Forza racing games.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-medium mb-2">
                  ...
                  <p className="leading-relaxed">
                    The color data is provided for reference purposes. Please check with the
                    original manufacturers for commercial usage rights.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-medium mb-2">❤️ How do I save my favorite colors?</h3>
                  <p className="leading-relaxed">
                    Click the heart icon on any color card to add it to your favorites. Your
            ...
            <div className="mt-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="leading-relaxed">
                    We support all modern browsers including Chrome, Firefox, Safari, and Edge. For
                    the best experience, please use the latest version of your browser.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-medium mb-2">⚡ Performance Issues</h3>
                  <p className="leading-relaxed">
                    If you experience slow loading, try clearing your browser cache or switching to
                    a less resource-intensive view mode.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-medium mb-2">🎮 Telemetry Setup</h3>
                  <p className="leading-relaxed">
                    For Forza telemetry issues, ensure UDP port 9999 is open and Data Out is enabled
                    in game settings. Run the fix-store script if using Microsoft Store version.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="mt-6">
              ...
              <ul className="space-y-2">
                <li>📧 Email: jayswervez@proton.me</li>
