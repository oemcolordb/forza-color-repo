      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="leading-relaxed">
              The materials on Forza Color Universe are provided on an 'as is' basis. 
              Forza Color Universe makes no warranties, expressed or implied, and hereby 
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              on Forza Color Universe, even if Forza Color Universe or an authorized representative 
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              typographical, or photographic errors. Forza Color Universe does not warrant 
          ...
          <section>
            ...
            <p className="leading-relaxed">
              Forza Color Universe may revise these terms of service at any time without notice. 
