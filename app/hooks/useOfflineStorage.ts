...
export function useOfflineStorage() {
  ...
  const cacheColors = useCallback(async (colors: CarColor[]) => {
  ...
  const getOfflineColors = useCallback(async (): Promise<CarColor[]> => {
    try {
  ...
  const searchOfflineColors = useCallback(async (query: string): Promise<CarColor[]> => {
    try {
