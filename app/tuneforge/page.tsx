...
export default function TuneForge() {
  ...
  const getAITuningAdvice = async () => {
    ...
    try {
      ...
      if (query.includes('understeer') || query.includes('push') || query.includes('front'))
        responseKey = 'understeer'
      else if (query.includes('oversteer') || query.includes('loose') || query.includes('rear'))
        responseKey = 'oversteer'
      ...
      else if (query.includes('speed') || query.includes('fast') || query.includes('straight'))
        responseKey = 'speed'
      else if (query.includes('rally') || query.includes('dirt') || query.includes('gravel'))
        responseKey = 'rally'
      else if (query.includes('track') || query.includes('circuit') || query.includes('lap'))
        responseKey = 'track'
      else if (weatherCondition === 'wet' || query.includes('rain') || query.includes('wet'))
        responseKey = 'wet'
