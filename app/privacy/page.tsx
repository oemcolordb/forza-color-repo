        ...
        <div className="prose dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="leading-relaxed mb-4">
              Forza Color Universe is designed with privacy in mind. We collect minimal information
          ...
          <section>
            ...
            <p className="leading-relaxed mb-4">
              We may use third-party services for analytics and performance monitoring. These
          ...
          <section>
            ...
            <p className="leading-relaxed mb-4">
              We use minimal cookies and local storage to remember your preferences such as theme
              selection and favorite colors. These enhance your user experience and are not used for
              tracking.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed mb-4">
              ...
              material changes by updating the date at the top of this policy.
            </p>
          </section>
